...
<html>
  <head>
	...
	{{ stylesheet_link('assets/plugins/pace/pace-theme-flash.css') }}
	...
	{{ stylesheet_link('assets/plugins/bootstrap-tag/bootstrap-tagsinput.css') }}
	{{ stylesheet_link('assets/plugins/dropzone/css/dropzone.css') }}
	{{ stylesheet_link('assets/plugins/bootstrap-datepicker/css/datepicker3.css',['media':'screen']) }}
	{{ stylesheet_link('assets/plugins/summernote/css/summernote.css',['media':'screen']) }}
	{{ stylesheet_link('assets/plugins/bootstrap-daterangepicker/daterangepicker-bs3.css',['media':'screen']) }}
	{{ stylesheet_link('assets/plugins/bootstrap-timepicker/bootstrap-timepicker.min.css',['media':'screen']) }}
	{{ stylesheet_link('pages/css/pages-icons.css') }}
	{{ stylesheet_link('pages/css/pages.css') }}
	{{ stylesheet_link('sweetalert/sweetalert.css') }}
	<!--{{ stylesheet_link('css/main.css') }}-->
	{{ stylesheet_link('assets/css/style.css') }}
	{{ stylesheet_link('assets/plugins/jquery-datatable/media/css/dataTables.bootstrap.min.css',['rel':'stylesheet']) }}
	{{ stylesheet_link('assets/plugins/jquery-datatable/extensions/FixedColumns/css/dataTables.fixedColumns.min.css',['rel':'stylesheet']) }}
	{{ stylesheet_link('assets/plugins/datatables-responsive/css/datatables.responsive.css',['rel':'stylesheet','media':'screen']) }}
	{{ stylesheet_link('css/main.css') }}
    <!--[if lte IE 9]>
	...
	{{ javascript_include('assets/plugins/jquery/jquery-1.11.1.min.js') }}
	{{ javascript_include('assets/plugins/modernizr.custom.js') }}
	{{ javascript_include('assets/plugins/jquery-ui/jquery-ui.min.js') }}
	{{ javascript_include('assets/plugins/bootstrapv3/js/bootstrap.min.js') }}
	{{ javascript_include('assets/plugins/jquery/jquery-easy.js') }}
	{{ javascript_include('assets/plugins/jquery-unveil/jquery.unveil.min.js') }}
	{{ javascript_include('assets/plugins/jquery-bez/jquery.bez.min.js') }}
	{{ javascript_include('assets/plugins/jquery-ios-list/jquery.ioslist.min.js') }}
	{{ javascript_include('assets/plugins/jquery-actual/jquery.actual.min.js') }}
	{{ javascript_include('assets/plugins/jquery-scrollbar/jquery.scrollbar.min.js') }}
	{{ javascript_include('assets/plugins/select2/js/select2.full.min.js') }}
	{{ javascript_include('assets/plugins/classie/classie.js') }}
	{{ javascript_include('assets/plugins/switchery/js/switchery.min.js') }}
	{{ javascript_include('assets/plugins/bootstrap3-wysihtml5/bootstrap3-wysihtml5.all.min.js') }}
	{{ javascript_include('assets/plugins/jquery-autonumeric/autoNumeric.js') }}
	{{ javascript_include('assets/plugins/dropzone/dropzone.min.js') }}
	{{ javascript_include('assets/plugins/bootstrap-tag/bootstrap-tagsinput.min.js') }}
	{{ javascript_include('assets/plugins/jquery-inputmask/jquery.inputmask.min.js') }}
	{{ javascript_include('assets/plugins/bootstrap-form-wizard/js/jquery.bootstrap.wizard.min.js') }}
	{{ javascript_include('assets/plugins/jquery-validation/js/jquery.validate.min.js') }}
	{{ javascript_include('assets/plugins/bootstrap-datepicker/js/bootstrap-datepicker.js') }}
	{{ javascript_include('assets/plugins/summernote/js/summernote.min.js') }}
	{{ javascript_include('assets/plugins/moment/moment.min.js') }}
	{{ javascript_include('assets/plugins/bootstrap-daterangepicker/daterangepicker.js') }}
	{{ javascript_include('assets/plugins/bootstrap-timepicker/bootstrap-timepicker.min.js') }}
	{{ javascript_include('assets/plugins/bootstrap-typehead/typeahead.bundle.min.js') }}
	...
	{{ javascript_include('assets/plugins/jquery-datatable/media/js/jquery.dataTables.min.js') }}
	{{ javascript_include('assets/plugins/jquery-datatable/extensions/TableTools/js/dataTables.tableTools.min.js') }}
	{{ javascript_include('assets/plugins/jquery-datatable/media/js/dataTables.bootstrap.js') }}
	{{ javascript_include('assets/plugins/jquery-datatable/extensions/Bootstrap/jquery-datatable-bootstrap.js') }}
	{{ javascript_include('assets/plugins/datatables-responsive/js/datatables.responsive.js') }}
	{{ javascript_include('assets/plugins/datatables-responsive/js/lodash.min.js') }}
  ...
  <body class="fixed-header">
    ...
    <div class="page-container ">
      ...
      <div class="page-content-wrapper bg-white full-height">
        <!-- START PAGE CONTENT -->
        <div class="content bg-white full-height">
			{% block content %}
			{% endblock %}
        </div>
		<!-- END PAGE CONTENT -->
        ...
        <div class="container-fluid container-fixed-lg footer">
          <div class="copyright sm-text-center">
            <p class="small no-margin pull-left sm-pull-reset">
              <span class="hint-text">Copyright &copy; <?php echo (int)date('Y') . " | "; ?> </span>
	...
	{{ javascript_include('pages/js/pages.min.js') }}
    <!-- END CORE TEMPLATE JS -->
    <!-- BEGIN PAGE LEVEL JS -->
	{{ javascript_include('assets/js/datatables.js') }}
	{{ javascript_include('assets/js/form_elements.js') }}
	{{ javascript_include('assets/js/scripts.js') }}
    <!-- END PAGE LEVEL JS -->
	{{ javascript_include('sweetalert/sweetalert-dev.js') }}
	<!--{{ javascript_include('css/main.js') }}-->
