	...
	<div class="top-content">
        <div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20">
            <ul class="breadcrumb">
                ...
                <li>
					<a href="#" class="active">Penunjang</a>
                </li>
            </ul>
        </div>
	</div>
				...
				<div class="row">
					...
					<div class="col-sm-4">
						...
						<div class="form-group ">
							<label><b>Kenakan Karcis</b></label>
							<div class="radio radio-primary">
								<input type="radio" checked="checked" value="A" name="rdikenakankarcis" id="A">
								<label for="A">Tidak</label>
								<input type="radio" value="B" name="rdigoldarah" id="B">
								<label for="B">Ya</label>
							</div>
						</div>	
					</div>
				</div>
