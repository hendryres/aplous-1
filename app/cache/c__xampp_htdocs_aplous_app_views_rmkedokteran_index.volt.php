    ...
    <nav class="page-sidebar" data-pages="sidebar">
      ...
      <div class="sidebar-menu">
        ...
        <ul class="menu-items">
		  ...
		  <li class="">
            <a href="javascript:;"><span class="title">Tindakan</span>
            <span class=" arrow"></span></a>
            <span class="icon-thumbnail">T</span>
			<ul class="sub-menu">
				<?php foreach ($data as $poli) { ?>
					<li class="">
						<a id="<?= $poli->idpoli ?>" class="link" href="#">
      ...
      <div class="page-content-wrapper bg-white full-height">
        ...
        <div class="content bg-white full-height p-b-0">
          ...
          <nav class="secondary-sidebar padding-30" style="height:100%" id="nav">
            ...
            <ul class="nav ">
				<?php foreach ($data as $poli) { ?>
				<li id="<?= $poli->liid ?>" class="">
					<a id="<?= $poli->linkid ?>" class="link" href="#">
						<span class="title"><i class="pg-folder"></i> <?= $poli->namapoli ?></span>
					</a>
				</li>
				<?php } ?>
...
(function($){
	...
	$(document).ready(function(){
		...
		e.preventDefault();
			...
			$.postJSON("Rmkedokteran/"+ btnid, dataForm, 
			function(data) {
		...
		if (document.getElementById("btninput").value == btnid)
			{
				...
				$.postJSON("Rmkedokteran/"+ btnid, dataForm, function(data) {
						var obj = data.emails;
						var group = data.group;
						var list = data.list;
...
(function($){
	$(document).ready(function(){
		$("#btninput").off("click").on("click", function(e){
			if (document.getElementById("btninput").value == "linkanak")
			{
							...
							<div class="row">\
								...
								<div class="col-sm-12">\
									<div class="form-group form-group-default form-group-default-select2">\
										...
										<select class="full-width" data-placeholder="Pilih ICD10" data-init-plugin="select2" name="cmbagama">\
